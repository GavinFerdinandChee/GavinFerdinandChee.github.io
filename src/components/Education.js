        ...
        <div className="my-64">
            ...
            " />
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4">
                    ...
                    <Details
                        type="Diploma/Associate's Degree in Mechatronics & Robotics"
                        time="2017-2020"
                        place="Singapore Polytechnic"
                        info="During my tenure at Singapore Polytechnic, I pursued a diploma in Mechatronics and Robotics, broadening my knowledge in this field. I attained 4 core module distinctions as well, Simultaneously, I made significant contributions to the school's Solar Racing Team, notably in the development of the SunSPEC 6 vehicle. I further expanded my expertise through a Diploma Plus program, earning a certificate in Aviation Management. Beyond academics, I was an active member of the SP Rotaract Club's executive committee, where I spearheaded the planning and execution of various community service-based events. This role enabled me to collaborate with beneficiaries and sister clubs from other institutions, further enhancing my leadership and community engagement skills."
                    />
